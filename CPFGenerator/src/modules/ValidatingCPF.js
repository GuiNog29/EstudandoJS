...
export default class ValidatingCPF {
  constructor(cpf) {
    this.cpf = cpf;
  }
  ...
  cpfValidate() {
    ...
    const digit1 = ValidatingCPF.generateDigit(parcialCPF);
    const digit2 = ValidatingCPF.generateDigit(parcialCPF + digit1);
  ...
  static generateDigit(parcialCPF) {
